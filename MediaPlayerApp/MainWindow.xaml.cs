...
namespace MediaPlayerApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private ObservableCollection<PlayListItem> shuffleList;
        ...
        private void PlayAndPauseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                PlaylistMediaElement.Pause();
                PlayAndPauseIconBlock.Icon = FontAwesome.Sharp.IconChar.PlayCircle;
                isPlay = false;
            }
            else
            {
                PlaylistMediaElement.Play();
                PlayAndPauseIconBlock.Icon = FontAwesome.Sharp.IconChar.PauseCircle;
                isPlay = true;
            }
        }
        ...
        private void CheckToEnableButton()
        {
            ...
            {
                NextIconBlock.Foreground = new SolidColorBrush(Colors.Gray);
            }
            else
            {
                NextIconBlock.Foreground = new SolidColorBrush(Colors.White);
            }

            if (currentIndex == 0)
            {
                PreviousIconBlock.Foreground = new SolidColorBrush(Colors.Gray);
            }
            else
            {
                PreviousIconBlock.Foreground = new SolidColorBrush(Colors.White);
            }
        }
        ...
        private void TypePlayButton_Click(object sender, RoutedEventArgs e)
        {
            if (!isShuffle)
            {
                TypePlayButton.Content = new Image
                {
                    Source = new BitmapImage(new Uri("Assets/Controls/repeat.png", UriKind.Relative)),
                };
                isShuffle = true;
            ...
            else
            {
                TypePlayButton.Content = new Image
                {
                    Source = new BitmapImage(new Uri("Assets/Controls/shuffle.png", UriKind.Relative)),
                };
                isShuffle = false;
        ...
        {
            shuffleList = new ObservableCollection<PlayListItem>(playlistItems);
            Random ramdom = new Random();
            int n = playlistItems.Count;

            while (n > 1)
            {
                n--;
                int k = ramdom.Next(n + 1);
                PlayListItem value = shuffleList[k];
